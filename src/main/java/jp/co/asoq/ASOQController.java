 ...
 */
@Controller
public class ASOQController {
	private static final Logger logger = LoggerFactory.getLogger(ASOQController.class);

	@RequestMapping(value = "/asoq.jsp", method = RequestMethod.GET)
	public String home(Locale locale, Model model) {
		return "asoq";
	}

	@RequestMapping(value = "/asoq.jsp", method = RequestMethod.POST)
