	...
	<div id="container">
		<h1>
			<img src="<c:url value="/resources/image/asoq_logo.png" />"
				width="100" height="90" class="stepbtn">ASOQ<span
				class="version">Ver 0.5.0</span>
		</h1>
		<div class="top">
			<p>
				ASOQ(Automatic Summarization for Open-ended Questionnaires)は、<br>自由記述アンケートの回答を自動的に要約するためのWEBシステムです。<br>
				ファイルをアップロードするだけで簡単に利用できます。
			</p>
		</div>
